<?php
/*
 * Copyright 2019 NxProGA\Google LLC
 *
...
namespace NxProGA\Google\Auth;

use DateTime;
use Exception;
use NxProGA\Firebase\JWT\ExpiredException;
use NxProGA\Firebase\JWT\JWT;
use NxProGA\Firebase\JWT\SignatureInvalidException;
use NxProGA\Google\Auth\Cache\MemoryCacheItemPool;
use NxProGA\Google\Auth\HttpHandler\HttpClientCache;
use NxProGA\Google\Auth\HttpHandler\HttpHandlerFactory;
use NxProGA\GuzzleHttp\Psr7\Request;
use NxProGA\GuzzleHttp\Psr7\Utils;
...
class AccessToken
{
    ...
    private function checkAndInitializePhpsec()
    {
        ...
        if (!class_exists('NxProGA\phpseclib\Crypt\RSA')) {
            throw new RuntimeException('Please require phpseclib/NxProGA\phpseclib v2 to use this utility.');
        }
    ...
    {
        $class = 'NxProGA\Firebase\JWT\JWT';
