...
use DomainException;
use NxProGA\Google\Auth\Credentials\AppIdentityCredentials;
...
use NxProGA\Google\Auth\Middleware\ProxyAuthTokenMiddleware;
 ...
 * authorizing a request to a NxProGA\Google service.
 *
 ...
 *
 * This allows it to be used as follows with NxProGA\GuzzleHttp\Client:
 *
 * ```
