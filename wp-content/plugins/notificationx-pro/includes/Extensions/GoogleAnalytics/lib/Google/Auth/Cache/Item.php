<?php
/*
 * Copyright 2016 NxProGA\Google Inc.
 *
...
namespace NxProGA\Google\Auth\Cache;

use NxProGA\Psr\Cache\CacheItemInterface;
...
final class Item implements CacheItemInterface
{
     ...
     *
     * @param string $error
     * @throws \NxProGA_NxProGA_TypeError
     */
    private function handleError($error)
    {
        if (class_exists('NxProGA_NxProGA_TypeError')) {
            throw new \NxProGA_NxProGA_TypeError($error);
        }
