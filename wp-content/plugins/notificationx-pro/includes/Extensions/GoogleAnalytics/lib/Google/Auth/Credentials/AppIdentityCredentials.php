...
/**
 * AppIdentityCredentials supports authorization on NxProGA\Google App Engine.
 *
    ...
    ProjectIdProviderInterface
{
    ...
    public static function onAppEngine()
    {
        $appEngineProduction = isset($_SERVER['SERVER_SOFTWARE']) &&
            0 === strpos($_SERVER['SERVER_SOFTWARE'], 'NxProGA\Google App Engine');
     ...
     * the NxProGA\GuzzleHttp\ClientInterface instance passed in will not be used.
     *
