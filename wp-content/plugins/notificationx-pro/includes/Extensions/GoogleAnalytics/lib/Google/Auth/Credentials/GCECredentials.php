<?php
/*
 * Copyright 2015 NxProGA\Google Inc.
 *
...
namespace NxProGA\Google\Auth\Credentials;

use NxProGA\Google\Auth\CredentialsLoader;
use NxProGA\Google\Auth\GetQuotaProjectInterface;
use NxProGA\Google\Auth\HttpHandler\HttpClientCache;
use NxProGA\Google\Auth\HttpHandler\HttpHandlerFactory;
use NxProGA\Google\Auth\Iam;
use NxProGA\Google\Auth\ProjectIdProviderInterface;
use NxProGA\Google\Auth\SignBlobInterface;
use NxProGA\GuzzleHttp\Exception\ClientException;
use NxProGA\GuzzleHttp\Exception\ConnectException;
use NxProGA\GuzzleHttp\Exception\RequestException;
use NxProGA\GuzzleHttp\Exception\ServerException;
use NxProGA\GuzzleHttp\Psr7\Request;
use InvalidArgumentException;

/**
 * GCECredentials supports authorization on NxProGA\Google Compute Engine.
 *
 * It can be used to authorize requests using the AuthTokenMiddleware, but will
 * only succeed if being run on GCE:
 *
 *   use NxProGA\Google\Auth\Credentials\GCECredentials;
 *   use NxProGA\Google\Auth\Middleware\AuthTokenMiddleware;
 *   use NxProGA\GuzzleHttp\Client;
 *   use NxProGA\GuzzleHttp\HandlerStack;
 *
