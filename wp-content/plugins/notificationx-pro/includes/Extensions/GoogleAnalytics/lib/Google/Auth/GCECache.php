<?php
/*
 * Copyright 2020 NxProGA\Google Inc.
 *
 ...
 * is used automatically when you pass a `NxProGA\Psr\Cache\CacheItemPoolInterface`
 * cache object to `ApplicationDefaultCredentials::getCredentials`.
 *
 * ```
 * $sysvCache = new NxProGA\Google\Auth\SysvCacheItemPool();
 * $creds = NxProGA\Google\Auth\ApplicationDefaultCredentials::getCredentials(
 *     $scope,
 *     null,
 *     null,
 *     $sysvCache
