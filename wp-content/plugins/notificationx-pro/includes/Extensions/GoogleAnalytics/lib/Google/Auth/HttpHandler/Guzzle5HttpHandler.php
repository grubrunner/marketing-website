<?php
/**
 * Copyright 2015 NxProGA\Google Inc. All Rights Reserved.
 *
 ...
 */
namespace NxProGA\Google\Auth\HttpHandler;

use Exception;
use NxProGA\GuzzleHttp\ClientInterface;
use NxProGA\GuzzleHttp\Message\ResponseInterface as Guzzle5ResponseInterface;
use NxProGA\GuzzleHttp\Promise\Promise;
...
class Guzzle5HttpHandler
{
    ...
    {
        if (!class_exists('NxProGA\GuzzleHttp\Promise\Promise')) {
