...
use DomainException;
use NxProGA\Google\AccessToken\Revoke;
use NxProGA\Google\AccessToken\Verify;
use NxProGA\Google\Auth\ApplicationDefaultCredentials;
use NxProGA\Google\Auth\Cache\MemoryCacheItemPool;
use NxProGA\Google\Auth\Credentials\ServiceAccountCredentials;
use NxProGA\Google\Auth\Credentials\UserRefreshCredentials;
...
use NxProGA\Google\Auth\OAuth2;
use NxProGA\Google\AuthHandler\AuthHandlerFactory;
use NxProGA\Google\Http\REST;
use NxProGA\GuzzleHttp\Client as GuzzleClient;
use NxProGA\GuzzleHttp\ClientInterface;
use NxProGA\GuzzleHttp\Ring\Client\StreamHandler;
use InvalidArgumentException;
use LogicException;
use NxProGA\Monolog\Handler\StreamHandler as MonologStreamHandler;
use NxProGA\Monolog\Handler\SyslogHandler as MonologSyslogHandler;
use NxProGA\Monolog\Logger;
use NxProGA\Psr\Cache\CacheItemPoolInterface;
use NxProGA\Psr\Http\Message\RequestInterface;
use NxProGA\Psr\Http\Message\ResponseInterface;
use NxProGA\Psr\Log\LoggerInterface;
use UnexpectedValueException;

/**
 * The NxProGA\Google API Client
...
class Client
{
    ...
    /**
     * Construct the NxProGA\Google Client.
     *
     * @param array $config
     */
    public function __construct(array $config = [])
    {
        $this->config = array_merge([
            ...
            // credentials (@see NxProGA\Google\Client::setAuthConfig), or an instance of
            // NxProGA\Google\Auth\CredentialsLoader.
            'credentials' => null,
            // @see NxProGA\Google\Client::setScopes
            'scopes' => null,
            ...
            // For use with NxProGA\Google Cloud Platform
            ...
            // @see NxProGA\Google\Task\Runner
            'retry' => [],
            'retry_map' => null,

            // Cache class implementing NxProGA\Psr\Cache\CacheItemPoolInterface.
            // Defaults to NxProGA\Google\Auth\Cache\MemoryCacheItemPool.
            'cache' => null,
            ...
            // Service class used in NxProGA\Google\Client::verifyIdToken.
        ...
        if (is_null($this->config['token_callback'])) {
            $this->config['token_callback'] = function ($cacheKey, $newAccessToken) {
                $this->setAccessToken(
                    ...
                    'expires_in' => 3600, // NxProGA\Google default
                    'created' => time(),
                    ]
                );
            };
    ...
    public function fetchAccessTokenWithAssertion(ClientInterface $authHttp = null)
    {
        if (!$this->isUsingApplicationDefaultCredentials()) {
            throw new DomainException(
                ...
                . ' NxProGA\Google\Client::setAuthConfig or set the path to your JSON file'
                . ' with the "GOOGLE_APPLICATION_CREDENTIALS" environment variable'
                . ' and call NxProGA\Google\Client::useApplicationDefaultCredentials to'
     ...
     * set in the NxProGA\Google API Client object
     *
    ...
    public function authorize(ClientInterface $http = null)
    {
        ...
        //   1.  Check if a NxProGA\Google\Auth\CredentialsLoader instance has been supplied via the "credentials" option
     ...
     * related to NxProGA\Google API PHP Client.)
     *
    ...
    public function isAccessTokenExpired()
    {
        ...
        if (isset($this->token['created'])) {
            ...
            // to the NxProGA\Google API server
     ...
     * NxProGA\Google Apps hosted accounts. By including the domain of the user, you
     ...
     * @throws \NxProGA\Google\Exception
    ...
    /**
     * Are we running in NxProGA\Google AppEngine?
     * return bool
     */
    public function isAppEngine()
    {
        return (isset($_SERVER['SERVER_SOFTWARE']) &&
            strpos($_SERVER['SERVER_SOFTWARE'], 'NxProGA\Google App Engine') !== false);
    }
     ...
     * the "Download JSON" button on in the NxProGA\Google Developer
     * Console.
    ...
    {
        $guzzleVersion = null;
        if (defined('\NxProGA\GuzzleHttp\ClientInterface::MAJOR_VERSION')) {
            $guzzleVersion = ClientInterface::MAJOR_VERSION;
        } elseif (defined('\NxProGA\GuzzleHttp\ClientInterface::VERSION')) {
