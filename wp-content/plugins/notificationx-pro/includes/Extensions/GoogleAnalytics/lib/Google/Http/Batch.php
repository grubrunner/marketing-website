<?php
/*
 * Copyright 2012 NxProGA\Google Inc.
 *
...
/**
 * Class to handle batched requests to the NxProGA\Google API service.
 *
 * Note that calls to `NxProGA\Google\Http\Batch::execute()` do not clear the queued
