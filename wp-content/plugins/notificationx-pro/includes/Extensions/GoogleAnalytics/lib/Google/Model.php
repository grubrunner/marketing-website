<?php
/*
 * Copyright 2011 NxProGA\Google Inc.
 *
...
{
    /**
     * If you need to specify a NULL JSON value, use NxProGA\Google\Model::NULL_VALUE
     ...
     * @throws \NxProGA\Google\Exception Thrown if $obj isn't an array.
