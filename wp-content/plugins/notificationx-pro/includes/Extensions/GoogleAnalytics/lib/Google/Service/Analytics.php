...
namespace NxProGA\Google\Service;

use NxProGA\Google\Client;

/**
 * Service definition for Analytics (v3).
 *
 * <p>
 * Views and manages your NxProGA\Google Analytics data.</p>
 *
 * <p>
 ...
 * @author Google, Inc.
 */
class Analytics extends \NxProGA\Google\Service
{
  /** View and manage your NxProGA\Google Analytics data. */
  const ANALYTICS =
      "https://www.googleapis.com/auth/analytics";
  /** Edit NxProGA\Google Analytics management entities. */
  const ANALYTICS_EDIT =
      "https://www.googleapis.com/auth/analytics.edit";
  /** Manage NxProGA\Google Analytics Account users by email address. */
  const ANALYTICS_MANAGE_USERS =
      "https://www.googleapis.com/auth/analytics.manage.users";
  /** View NxProGA\Google Analytics user permissions. */
  const ANALYTICS_MANAGE_USERS_READONLY =
      "https://www.googleapis.com/auth/analytics.manage.users.readonly";
  /** Create a new NxProGA\Google Analytics account along with its default property and view. */
  const ANALYTICS_PROVISION =
      "https://www.googleapis.com/auth/analytics.provision";
  /** View your NxProGA\Google Analytics data. */
  const ANALYTICS_READONLY =
      "https://www.googleapis.com/auth/analytics.readonly";
  /** Manage NxProGA\Google Analytics user deletion requests. */
