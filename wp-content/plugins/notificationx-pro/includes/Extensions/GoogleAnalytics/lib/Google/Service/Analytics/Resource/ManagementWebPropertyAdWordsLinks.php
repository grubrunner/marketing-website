...
use NxProGA\Google\Service\Analytics\EntityAdWordsLink;
use NxProGA\Google\Service\Analytics\EntityAdWordsLinks;
 ...
 *  </code>
 */
class ManagementWebPropertyAdWordsLinks extends \NxProGA\Google\Service\Resource
{
  /**
   * Deletes a web property-NxProGA\Google Ads link. (webPropertyAdWordsLinks.delete)
   *
   * @param string $accountId ID of the account which the given web property
   * belongs to.
   * @param string $webPropertyId Web property ID to delete the NxProGA\Google Ads link
   * for.
   * @param string $webPropertyAdWordsLinkId Web property NxProGA\Google Ads link ID.
  ...
  /**
   * Returns a web property-NxProGA\Google Ads link to which the user has access.
   * (webPropertyAdWordsLinks.get)
   *
   * @param string $accountId ID of the account which the given web property
   * belongs to.
   * @param string $webPropertyId Web property ID to retrieve the NxProGA\Google Ads link
   * for.
   * @param string $webPropertyAdWordsLinkId Web property-NxProGA\Google Ads link ID.
   * @param array $optParams Optional parameters.
  ...
  /**
   * Creates a webProperty-NxProGA\Google Ads link. (webPropertyAdWordsLinks.insert)
   *
   * @param string $accountId ID of the NxProGA\Google Analytics account to create the
   * link for.
  ...
  /**
   * Lists webProperty-NxProGA\Google Ads links for a given web property.
   * (webPropertyAdWordsLinks.listManagementWebPropertyAdWordsLinks)
   *
   * @param string $accountId ID of the account which the given web property
   * belongs to.
   * @param string $webPropertyId Web property ID to retrieve the NxProGA\Google Ads links
   * for.
   * @param array $optParams Optional parameters.
   *
   * @opt_param int max-results The maximum number of webProperty-NxProGA\Google Ads links
   * to include in this response.
   * @opt_param int start-index An index of the first webProperty-NxProGA\Google Ads link
  ...
  /**
   * Updates an existing webProperty-NxProGA\Google Ads link. This method supports patch
  ...
  /**
   * Updates an existing webProperty-NxProGA\Google Ads link.
