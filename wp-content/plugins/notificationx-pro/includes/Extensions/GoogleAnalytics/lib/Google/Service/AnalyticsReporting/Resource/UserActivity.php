...
namespace NxProGA\Google\Service\AnalyticsReporting\Resource;

use NxProGA\Google\Service\AnalyticsReporting\SearchUserActivityRequest;
use NxProGA\Google\Service\AnalyticsReporting\SearchUserActivityResponse;

/**
 * The "userActivity" collection of methods.
 * Typical usage is:
 *  <code>
 *   $analyticsreportingService = new NxProGA\Google\Service\AnalyticsReporting(...);
 *   $userActivity = $analyticsreportingService->userActivity;
 *  </code>
 */
class UserActivity extends \NxProGA\Google\Service\Resource
{
  /**
