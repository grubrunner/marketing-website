...
use NxProGA\Google\Http\MediaFileUpload;
use NxProGA\Google\Model;
use NxProGA\Google\Utils\UriTemplate;
use NxProGA\GuzzleHttp\Psr7\Request;

/**
 * Implements the actual methods/resources of the discovered NxProGA\Google API using magic function
...
class Resource
{
    ...
    /** @var \NxProGA\Google\Client $client */
    private $client;
