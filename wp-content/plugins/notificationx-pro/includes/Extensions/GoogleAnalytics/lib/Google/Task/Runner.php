...
namespace NxProGA\Google\Task;

use NxProGA\Google\Service\Exception as GoogleServiceException;
use NxProGA\Google\Task\Exception as GoogleTaskException;
...
class Runner
{
     ...
     * @throws \NxProGA\Google\Task\Exception when misconfigured
     */
     ...
     *
     * @return mixed
     * @throws \NxProGA\Google\Service\Exception on failure when no retries are available.
     */
    public function run()
    {
        while ($this->attempt()) {
