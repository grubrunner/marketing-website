...
use Exception;
use NxProGA\Monolog\Formatter\LineFormatter;
use NxProGA\Monolog\Logger;
use NxProGA\Monolog\Utils;
use PhpConsole\Connector;
use PhpConsole\Handler;
use PhpConsole\Helper;

/**
 * NxProGA\Monolog handler for Google Chrome extension "PHP Console"
 *
 ...
 *
 *      $logger = new \NxProGA\Monolog\Logger('all', array(new \NxProGA\Monolog\Handler\PHPConsoleHandler()));
 *      \NxProGA\Monolog\ErrorHandler::register($logger);
 *      echo $undefinedVar;
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    private $options = array(
        ...
        'classesPartialsTraceIgnore' => array('NxProGA\Monolog\\'), // array Hide calls of classes started with...
    ...
    /**
     * @param  array          $options   See \NxProGA\Monolog\Handler\PHPConsoleHandler::$options for more details
