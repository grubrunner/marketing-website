...
use NxProGA\Monolog\Handler\HandlerInterface;
use NxProGA\Monolog\Handler\StreamHandler;
use NxProGA\Psr\Log\LoggerInterface;
use NxProGA\Psr\Log\InvalidArgumentException;
use Exception;

/**
 * NxProGA\Monolog log channel
 *
...
class Logger implements LoggerInterface, ResettableInterface
{
    ...
    /**
     * Converts PSR-3 levels to NxProGA\Monolog ones if necessary
     *
