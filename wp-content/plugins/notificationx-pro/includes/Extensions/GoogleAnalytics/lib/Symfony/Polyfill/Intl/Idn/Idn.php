...
namespace NxProGA\Symfony\Polyfill\Intl\Idn;

use Exception;
use NxProGA_NxProGA_Normalizer;
use NxProGA\Symfony\Polyfill\Intl\Idn\Resources\unidata\DisallowedRanges;
use NxProGA\Symfony\Polyfill\Intl\Idn\Resources\unidata\Regex;
...
final class Idn
{
    ...
    private static function process($domain, array $options, Info $info)
    {
        ...
        if (!NxProGA_NxProGA_Normalizer::isNormalized($domain, NxProGA_NxProGA_Normalizer::FORM_C)) {
            $domain = NxProGA_NxProGA_Normalizer::normalize($domain, NxProGA_NxProGA_Normalizer::FORM_C);
        }
    ...
    private static function validateLabel($label, Info $info, array $options, $canBeEmpty)
    {
        ...
        if (!NxProGA_NxProGA_Normalizer::isNormalized($label, NxProGA_NxProGA_Normalizer::FORM_C)) {
