...
/**
 * Base Class for all \NxProGA\phpseclib\Crypt\* cipher classes
 *
 * PHP version 5
 *
 * Internally for NxProGA\phpseclib developers:
 *  If you plan to add a new cipher class, please note following rules:
 *
 *  - The new \NxProGA\phpseclib\Crypt\* cipher class should extend \NxProGA\phpseclib\Crypt\Base
 *
 ...
 *
 *  - Look at the source code of the current ciphers how they extend \NxProGA\phpseclib\Crypt\Base
...
abstract class Base
{
     ...
     *
     * @see \NxProGA\phpseclib\Crypt\Base::_hashInlineCryptFunction()
     * @var bool
     * @access private
     */
     ...
     *
     * @see \NxProGA\phpseclib\Crypt\Twofish::setKey()
     * @see \NxProGA\phpseclib\Crypt\Twofish::setIV()
     * @var bool
     * @access private
     */
    var $enchanged = true;
     ...
     * is broken, so NxProGA\phpseclib implements the CFB mode by it self,
     * even when the mcrypt php extension is available.
     *
     * In order to do the CFB-mode work (fast) NxProGA\phpseclib
     ...
     *
     * SetIV is not required when self::MODE_ECB (or ie for AES: \NxProGA\phpseclib\Crypt\AES::MODE_ECB) is being used.  If not explicitly set, it'll be assumed
     * to be all zero's.
     *
     * @access public
     * @param string $iv
    ...
    /**
     * NxProGA\phpseclib <-> OpenSSL Mode Mapper
     *
     ...
     *
     * Put another way, when the continuous buffer is enabled, the state of the \NxProGA\phpseclib\Crypt\*() object changes after each
     ...
     *
     * - \NxProGA\phpseclib\Crypt\Base::ENGINE_OPENSSL  [very fast]
     *
     * - \NxProGA\phpseclib\Crypt\Base::ENGINE_MCRYPT   [fast]
     *
     * - \NxProGA\phpseclib\Crypt\Base::ENGINE_INTERNAL [slow]
     *
     ...
     * Encrypts a block
     *
     * Note: Must be extended by the child \NxProGA\phpseclib\Crypt\* class
     *
     * @access private
     * @param string $in
     * @return string
     ...
     *
     * Note: Must extend by the child \NxProGA\phpseclib\Crypt\* class
     *
     * @see self::_setup()
     * @access private
     */
     ...
     *       - In case of using inline crypting, _setupInlineCrypt() must extend by the child \NxProGA\phpseclib\Crypt\* class.
    ...
    {
        // If, for any reason, an extending \NxProGA\phpseclib\Crypt\Base() \NxProGA\phpseclib\Crypt\* class
        // not using inline crypting then it must be ensured that: $this->use_inline_crypt = false
        // ie in the class var declaration of $use_inline_crypt in general for the \NxProGA\phpseclib\Crypt\* class,
     ...
     *    </code>
     *
     *    See also the \NxProGA\phpseclib\Crypt\*::_setupInlineCrypt()'s for
