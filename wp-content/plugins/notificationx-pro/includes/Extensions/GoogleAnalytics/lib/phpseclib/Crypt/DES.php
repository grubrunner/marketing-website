 ...
 *
 *    $des = new \NxProGA\phpseclib\Crypt\DES();
 *
 *    $des->setKey('abcdefgh');
 *
 *    $size = 10 * 1024;
...
class DES extends Base
{
     ...
     * @see \NxProGA\phpseclib\Crypt\DES::_processBlock()
     */
    /**
     ...
     *
     * @see \NxProGA\phpseclib\Crypt\Base::openssl_mode_names
     * @var array
     * @access private
     */
     ...
     *
     * @see \NxProGA\phpseclib\Crypt\Base::isValidEngine()
     * @param int $engine
     * @access public
     * @return bool
     */
