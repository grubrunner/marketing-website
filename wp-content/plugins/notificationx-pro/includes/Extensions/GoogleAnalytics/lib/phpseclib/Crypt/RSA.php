 ...
 *
 *    $rsa = new \NxProGA\phpseclib\Crypt\RSA();
...
class RSA
{
    ...
    */
    ...
    /**#@+
     * @access private
     * @see \NxProGA\phpseclib\Crypt\RSA::createKey()
    */
    /**
     * ASN1 Integer
     */
    ...
    /**#@+
     * @access private
     * @see \NxProGA\phpseclib\Crypt\RSA::__construct()
    */
    /**
     ...
     * @access public
     * @see \NxProGA\phpseclib\Crypt\RSA::createKey()
     * @see \NxProGA\phpseclib\Crypt\RSA::setPrivateKeyFormat()
    */
    /**
     ...
     * @access public
     * @see \NxProGA\phpseclib\Crypt\RSA::createKey()
     * @see \NxProGA\phpseclib\Crypt\RSA::setPublicKeyFormat()
    */
    /**
     * Raw public key
     *
     * An array containing two \NxProGA\phpseclib\Math\BigInteger objects.
     *
     ...
     * Precomputed Zero
     *
     * @var \NxProGA\phpseclib\Math\BigInteger
     * @access private
     */
    var $zero;
     ...
     * Hash function
     *
     * @var \NxProGA\phpseclib\Crypt\Hash
     * @access private
     */
    var $hash;
     ...
     * \NxProGA\phpseclib\Crypt\RSA doesn't do it is because OpenSSL doesn't fail gracefully.  openssl_pkey_new(), in particular, requires
     * openssl.cnf be present somewhere and, unfortunately, the only real way to find out is too late.
     *
     * @return \NxProGA\phpseclib\Crypt\RSA
     * @access public
     */
     ...
     *                  Will need to be passed back to \NxProGA\phpseclib\Crypt\RSA::createKey() as the third parameter for further processing.
     *
     * @access public
     * @param int $bits
     * @param int $timeout
     ...
     * exponent this won't work unless you manually add the public exponent. NxProGA\phpseclib tries to guess if the key being used
     ...
     *
     * If NxProGA\phpseclib guessed a private key was a public key and loaded it as such it might be desirable to force
     * NxProGA\phpseclib to treat the key as a private key. This function will do that.
     *
     * Do note that when a new key is loaded the index will be cleared.
     *
     * Returns true on success, false on failure
    ...
    {
        // \NxProGA\phpseclib\Crypt\Hash supports algorithms that PKCS#1 doesn't support.  md5-96 and sha1-96, for example.
        switch ($hash) {
            case 'md2':
            case 'md5':
            case 'sha1':
     ...
     *
     * @access private
     * @param \NxProGA\phpseclib\Math\BigInteger $x
     * @param int $xLen
     * @return string
     */
     ...
     * @return \NxProGA\phpseclib\Math\BigInteger
     */
    function _os2ip($x)
    {
     ...
     * @access private
     * @param \NxProGA\phpseclib\Math\BigInteger $x
     * @param \NxProGA\phpseclib\Math\BigInteger $r
     * @param int $i
     * @return \NxProGA\phpseclib\Math\BigInteger
     */
     ...
     *
     * @access private
     * @param \NxProGA\phpseclib\Math\BigInteger $m
     * @return \NxProGA\phpseclib\Math\BigInteger
     */
    function _rsaep($m)
    {
     ...
     *
     * @access private
     * @param \NxProGA\phpseclib\Math\BigInteger $c
     * @return \NxProGA\phpseclib\Math\BigInteger
     */
    function _rsadp($c)
    {
     ...
     *
     * @access private
     * @param \NxProGA\phpseclib\Math\BigInteger $s
     * @return \NxProGA\phpseclib\Math\BigInteger
     */
    function _rsavp1($s)
    {
     ...
     *
     * As a consequence of this, a private key encrypted ciphertext produced with \NxProGA\phpseclib\Crypt\RSA may not decrypt
