 ...
 * DER blobs.
 *
 * \NxProGA\phpseclib\File\ASN1 decodes and encodes DER formatted messages and places them in a semantic context.
 *
...
class ASN1
{
    ...
    */
     ...
     *
     * Structured or unknown types are mapped to a \NxProGA\phpseclib\File\ASN1\Element.
    ...
    function _decodeTime($content, $tag)
    {
        ...
        if ($tag == self::TYPE_UTC_TIME) {
            ...
            // browsers parse it NxProGA\phpseclib ought to too
     ...
     * Load filters
     *
     * See \NxProGA\phpseclib\File\X509, etc, for an example.
     *
     * @access public
     * @param array $filters
     */
