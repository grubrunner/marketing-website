 ...
 *        exit('bad login');
 *    }
 *    $scp = new \NxProGA\phpseclib\Net\SCP($ssh);
 *
...
class SCP
{
    /**#@+
     * @access public
     * @see \NxProGA\phpseclib\Net\SCP::put()
     */
    /**
    ...
    /**#@+
     * @access private
     * @see \NxProGA\phpseclib\Net\SCP::_send()
     * @see \NxProGA\phpseclib\Net\SCP::_receive()
    */
    /**
     * SSH1 is being used.
     */
     ...
     *
     * @param \NxProGA\phpseclib\Net\SSH1|\NxProGA\phpseclib\Net\SSH2 $ssh
     * @return \NxProGA\phpseclib\Net\SCP
     * @access public
     */
     ...
     *
     * By default, \NxProGA\phpseclib\Net\SCP::put() does not read from the local filesystem.  $data is dumped directly into $remote_file.
     * So, for example, if you set $data to 'filename.ext' and then do \NxProGA\phpseclib\Net\SCP::get(), you will get a file, twelve bytes
