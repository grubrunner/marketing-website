 ...
 *
 *    $agent = new \NxProGA\phpseclib\System\SSH\Agent();
 *
...
namespace NxProGA\phpseclib\System\SSH;

use NxProGA\phpseclib\Crypt\RSA;
use NxProGA\phpseclib\System\SSH\Agent\Identity;

/**
 * Pure-PHP ssh-agent client identity factory
 *
 * requestIdentities() method pumps out \NxProGA\phpseclib\System\SSH\Agent\Identity objects
 *
 * @package SSH\Agent
 * @author  Jim Wigginton <terrafrost@php.net>
 * @access  public
...
class Agent
{
     ...
     * Default Constructor
     *
     * @return \NxProGA\phpseclib\System\SSH\Agent
     * @access public
     */
     ...
     * Returns an array containing zero or more \NxProGA\phpseclib\System\SSH\Agent\Identity objects
     *
     * @return array
     * @access public
     */
