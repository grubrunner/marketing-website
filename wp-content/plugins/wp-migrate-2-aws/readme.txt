...
**Get Free Licence Key** Simply [Click Here](https://www.seahorse-data.com/checkout?edd_action=add_to_cart&download_id=8272) to get a licence key to use the plugin today. Clone any site now to see your site in AWS for Free! No license fees or AWS usage charges will apply. Trial instances stay active for 6 hours after launch.
...
* v.5.0.* v.5 Self-Managed Solution upgraded media transfer release: Jun 08, 2023 [WCEU 23](https://europe.wordcamp.org/2023/)
