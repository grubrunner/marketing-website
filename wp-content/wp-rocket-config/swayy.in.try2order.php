...
$rocket_cookie_hash = '6c36fc9ea2acdda9a61db860af61e7ff';
$rocket_logged_in_cookie = 'wordpress_logged_in_6c36fc9ea2acdda9a61db860af61e7ff';
$rocket_cache_mobile_files_tablet = 'desktop';
$rocket_cache_mobile = 1;
$rocket_cache_reject_uri = '/try2order(/(?:.+/)?feed(?:/(?:.+/?)?)?$|/(?:.+/)?embed/|/(index\.php/)?(.*)wp\-json(/.*|$))';
