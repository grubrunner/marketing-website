...
$rocket_cookie_hash = '2a13218ec303862ac067438cf0f2dcef';
$rocket_logged_in_cookie = 'wordpress_logged_in_2a13218ec303862ac067438cf0f2dcef';
$rocket_cache_mobile_files_tablet = 'desktop';
$rocket_cache_mobile = 1;
$rocket_cache_reject_uri = '/trytext2order(/(?:.+/)?feed(?:/(?:.+/?)?)?$|/(?:.+/)?embed/|/(index\.php/)?(.*)wp\-json(/.*|$))';
